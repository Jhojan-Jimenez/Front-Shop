export default function FilterModal({
	...
	return (
		<form
			...
			tabIndex={-1}
			aria-hidden='true'
			className={`fixed left-0 right-0 top-0 z-50  h-modal w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0 md:h-full ${
				show ? '' : 'hidden'
			}`}
		>
				...
				<div className='relative rounded-lg bg-white shadow dark:bg-gray-800'>
					<div className='flex items-start justify-between rounded-t p-4 md:p-5'>
						...
						>
							...
							<span className='sr-only'>Close modal lore</span>
						</button>
					</div>
					{/* <!-- Modal body --> */}
